...
G1B_R4_HOLD="$REPO/reports/v5/p2_g1b_r4_source_only_graph_implementation_smoke"
...
SCRIPT="$REPO/scripts/v5/p2/smoke_v5_p2_g1b_r5_source_only_graph_implementations.py"
OUT="$REPO/reports/v5/p2_g1b_r5_source_only_graph_implementation_smoke"
LOG="$REPO/logs/v5/v5_p2_g1b_r5_source_only_graph_implementation_smoke.log"

echo "===== V5 P2-G1B-R5 SOURCE-ONLY GRAPH SMOKE ====="
echo "repo=$REPO"
echo "g0=$G0"
echo "r1=$R1"
...
echo "historical_g1b_r4_hold=$G1B_R4_HOLD"
echo "data=$DATA"
echo "loader=$LOADER"
echo "model=$MODEL"
echo "script=$SCRIPT"
...
echo "historical_g1b_r4_hold_preserved=true"
echo "topology_wrapper_key=canonical_contract"
...
echo
echo "v5_p2_g1b_r5_status=$status"

if [ -f "$OUT/V5_P2_G1B_R5_SOURCE_ONLY_GRAPH_IMPLEMENTATION_SMOKE_COMPLETE" ]; then
    cat "$OUT/V5_P2_G1B_R5_SOURCE_ONLY_GRAPH_IMPLEMENTATION_SMOKE_COMPLETE"
elif [ -f "$OUT/V5_P2_G1B_R5_SOURCE_ONLY_GRAPH_IMPLEMENTATION_SMOKE_HOLD" ]; then
    cat "$OUT/V5_P2_G1B_R5_SOURCE_ONLY_GRAPH_IMPLEMENTATION_SMOKE_HOLD"
else
